...
# Description
For modifications and my last milestone, I added a vibration motor, soldered all my wires to the pcb, and finally sewed or velcro taped everything to my wrist compression band. The vibration motor works by rotating an unbalanced mass, and this rotation causes vibrations. Or, another vibartion motor has internal parts that instead of rotating, move forward and back to create the vibration effect. The vibration motor was to alert my wrist of bad posture when none of the serial processes were running. Sort of like a "stealth mode" to ensure that my wrist would stay out of the bad range. So in the code, when none of the other processes were running, the vibration motor would be turned on (refer to Milestone 4 Modification Code, Appendix). I added the thresholds to the vibration motor for pitch. I tried doing some more specific thresholds with the roll values, but I decided to keep it simple with just the pitch. Since all values that come out from out of the accelerometer are relative to its position, the vibration motor kept vibrating if I moved my arm, not just my wrist. So, I decided to just to the pitch data. Soldering wires were relatively straightforward, with minor complications. 
The only component that I had to sew to the wrist compression band was the esp32. Because of all the pins, I sewed it upside down as pins poking into my skin would be quite uncomfortable while exercising. For the flex sensor, neopixel strip, and the actual pcb board, I used velcro tape to secure it onto the wrist band.
...
| Flex Sensor 4.5" | Measures wrist tilt | $17.95 | <a href="https://www.sparkfun.com/flex-sensor-4-5.html"> Link </a> |
| Adafruit LSM6DS3+LIS3MDL | Accelerometer, Gyroscope, and Magnometer | $19.95 | <a href="https://www.adafruit.com/product/5543?gad_source=1&gclid=Cj0KCQjw4MSzBhC8ARIsAPFOuyW3bKrwhMSo2VoSfvSt319uDnnbDld4MoYm0IzXAV2mbivYMjEGez4aApeGEALw_wcB"> Link </a> |
| Wrist Compression Sleeve | Main baseplate for all components | $15.97 | <a href="https://www.amazon.com/Sparthos-Wrist-Support-Sleeves-Pair/dp/B074CXL9RM/ref=sxin_16_pa_sp_search_thematic-asin_sspa?content-id=amzn1.sym.f5052e1c-21bb-4068-ada8-6befb6325d04%3Aamzn1.sym.f5052e1c-21bb-4068-ada8-6befb6325d04&crid=BSDK6TEHKM0P&cv_ct_cx=wrist%2Bcompression%2Bsleeve&dib=eyJ2IjoiMSJ9.a0DsiZrtl24MGErE3gc3hs-1seJpCWa444LFuc4uL7pQ2OfUK_CsEha6Uf9uNkDHGCFhBOGcesu0YlU33vWUZg.4T09Mf5m41lcN3unhAgnkf-BS-7wLZL42PAvfgzOW1I&dib_tag=se&keywords=wrist%2Bcompression%2Bsleeve&pd_rd_i=B07G4JCSJ7&pd_rd_r=5b8b03e2-eea7-49ee-9e5f-8cbb186e681e&pd_rd_w=S03mj&pd_rd_wg=NPat3&pf_rd_p=f5052e1c-21bb-4068-ada8-6befb6325d04&pf_rd_r=0BBVYDM9P8428SY3RMC3&qid=1719355435&sbo=RZvfv%2F%2FHxDF%2BO5021pAnSA%3D%3D&sprefix=wrist%2Bcompress%2Caps%2C446&sr=1-2-baa1f287-65d3-41a3-a655-8bbba0531537-spons&sp_csd=d2lkZ2V0TmFtZT1zcF