...
## Piezo Buzzer
The piezo buzzer has a piezoelectric ceramic disk inside of it. Piezoelectric materials, such as the disk, produce physical deformation when an alternating voltage is applied to the buzzer, the ceramic disk rapidly expands and contracts. This movement pulls on the surrounding air and generates sound waves (see figure 12). The pitch and frequency of the buzzer is determined by how fast this ceramic disk is vibrating. Higher rates of vibration result in higher pitch and vice versa. 
